/*! @remino/jukette-core v0.8.1 | (c) 2026 Rémino Rem <https://remino.net/> | ISC Licence */
...
//#endregion
export { JukettePlayableTrack, JukettePlayerElement, JuketteTrackElement, cleanMetadataText, createJuketteEventDetail, decodeAscii, decodeIso88591, decodeTextBytes, decodeUtf16Be, defineElement, defineElements, defineJuketteElement, defineJuketteElements, formatTrackDisplay, getJuketteBackend, getRegisteredJuketteBackends, inferTrackType, normalizeDisplayMarquee, normalizeMidiOscillator, normalizeTrack, parsePlaylist, registerJuketteBackend, resetJuketteBackends, resolveJuketteBackend, subscribeJuketteBackendRegistrations, trackFromElement };
