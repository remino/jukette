/*! @remino/jukette-midi v0.8.1 | (c) 2026 Rémino Rem <https://remino.net/> | ISC Licence */
...
exports.loadMidiSequence = loadMidiSequence;
exports.midiProgramToOscillator = midiProgramToOscillator;
Object.defineProperty(exports, "normalizeMidiOscillator", {
	enumerable: true,
	get: function() {
		return _remino_jukette_core.normalizeMidiOscillator;
	}
});
