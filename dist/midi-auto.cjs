...
//#endregion
//#region node_modules/@tonejs/midi/dist/Midi.js
var require_Midi = /* @__PURE__ */ __commonJSMin(((exports) => {
...
var ToneMidi = (/* @__PURE__ */ __toESM(require_Midi(), 1)).default.Midi;
...
var midiPlaybackRuntime = {
	createPart(callback, notes) {
		return new Part(callback, notes);
	},
	get now() {
		return now();
	},
